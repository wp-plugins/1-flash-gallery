					...
					if (count($rows) > 0) {
						...
						foreach ($rows as $row) {
							switch ($album['gall_type']) {
								...
								break;
								case 7:
									echo '<img type="page" align="fill" title="'.$row['img_caption'].'" file="'.$siteurl.$row['img_path'].'" file_b="" url="" />';
								break;
							}
						}
						echo "</folder>";
							...
							switch ($album['gall_type']) {
								...
								break;
								case 7:
									$nofolder .= '<img type="page" align="fill" title="'.$image['img_caption'].'" file="'.$siteurl.$image['img_path'].'" file_b="" url="" />';
								break;
							}
				}
			}
