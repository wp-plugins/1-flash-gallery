            ...
            if ($image['img_vs_folder'] == 2) {
                    ...
                    if (count($rows) > 0) {
                            ...
                            foreach ($rows as $row) {
                                ...
                                if ($row['img_preview_path'] != '') {
                                    $preview_path = $row['img_preview_path'];
                                } else {
                                ...
                                $description = fgallery_sanitize_string($row['img_description']);
                                    switch ($album['gall_type']) {
                                            ...
                                            case 12:
                                                    echo '<img id="'.$row['img_id'].'_'.$album['gall_id'].'" file="'.$siteurl.$preview_path.'" file_b="'.$siteurl.$img_path.'" title="'.$title.'" url="'.$row['img_url'].'"><![CDATA['.$description.']]></img>'; 
                                            break;
                                            case 7:
                                            ...
                                            break;
                                            case 10:
                                                echo '<img id="'.$row['img_id'].'_'.$album['gall_id'].'" file="'.$siteurl.$preview_path.'" file_b="'.$siteurl.$img_path.'" title="'.$title.'" link="'.$row['img_url'].'" target="_blank"><![CDATA['.$description.']]></img>';
                                            break;
                ...
                switch ($album['gall_type']) {
                        ...
                        case 8: case 9: case 11: 
			case 12:
                                $nofolder .= '<img id="'.$image['img_id'].'_'.$album['gall_id'].'" file_b="'.$siteurl.$img_path.'" file="'.$siteurl.$preview_path.'" title="'.$title.'" url="'.$image['img_url'].'"><![CDATA['.$description.']]></img>'; 
                        break;
                        case 7:
                        ...
                        break;
                        case 10:
                             $nofolder .= '<img id="'.$image['img_id'].'_'.$album['gall_id'].'" file="'.$siteurl.$preview_path.'" file_b="'.$siteurl.$img_path.'" title="'.$title.'" link="'.$image['img_url'].'" target="_blank"><![CDATA['.$description.']]></img>';
                        break;
