...
function fgallery_config(){
	...
	case 1:
            echo '<gallery>
                        <source>'.$config['sc_slideshow__source'].'</source>
                </gallery>
                <slideshow>
                        <pauseMusic>'.$config['sc_slideshow__pauseMusic'].'</pauseMusic>
                        <sendID>'.$config['sc_slideshow__sendID'].'</sendID>
           ...
           echo '</slideshow>
                <image>
                        ...
                        <stopByClick>'.$config['sc_image__stopByClick'].'</stopByClick>
                        ...
                        <shadow>'.$config['sc_image__shadow'].'</shadow>
                        <shadowColor>'.str_replace('#','0x',$config['sc_image__shadowColor']).'</shadowColor>
                        <shadowAlpha>'.$config['sc_image__shadowAlpha'].'</shadowAlpha>
                        <shadowBlur>'.$config['sc_image__shadowBlur'].'</shadowBlur>
                        <shadowDistance>'.$config['sc_image__shadowDistance'].'</shadowDistance>
                </image>
                <background>
	...
	case 7:
            ...
            echo '<main>
                        ...
                        <pageFrameColor>'.str_replace('#','0x',$config['sc_main__pageFrameColor']).'</pageFrameColor>
	...
	case 9:
            echo '<gallery>
                	...
                	<navigation>
                    	<showFullScreen>'.$config['sc_navigation__showFullScreen'].'</showFullScreen>
                    	<showPlay>'.$config['sc_navigation__showPlay'].'</showPlay>
                    </navigation>
                    <slideshow>
                            <enable>'.(int)$config['sc_slideshow__enable'].'</enable>
                            <delay>'.$config['sc_slideshow__delay'].'</delay>
	...
	case 10:
            echo '<gallery>
                    ...
                    <slideshow>
                            ...
                            <backgroundPath>'.$config['sc_slideshow__backgroundPath'].'</backgroundPath>
                            <backgroundAlpha>'.$config['sc_slideshow__backgroundAlpha'].'</backgroundAlpha>
                            <stopMusicWhenShowStop>'.$config['sc_slideshow__stopMusicWhenShowStop'].'</stopMusicWhenShowStop>
                            <autostartSlideshow>'.$config['sc_slideshow__autostartSlideshow'].'</autostartSlideshow>
            ...
            echo '</slideshow>
                    ...
                    <scroller>
                            ...
                            <cornerRadius>'.$config['sc_scroller__cornerRadius'].'</cornerRadius>
                            <shadow>'.$config['sc_scroller__shadow'].'</shadow>
                            <shadowDistance>'.$config['sc_scroller__shadowDistance'].'</shadowDistance>
                            <shadowSize>'.$config['sc_scroller__shadowSize'].'</shadowSize>
                            <shadowColor>0x'.str_replace("#", '', $config['sc_scroller__shadowColor']).'</shadowColor>
                            <shadowAngle>'.$config['sc_scroller__shadowAngle'].'</shadowAngle>
                    ...
                    <preview>
                            ...
                            <shadowDistance>'.$config['sc_preview__shadowDistance'].'</shadowDistance>
                            <shadowSize>'.$config['sc_preview__shadowSize'].'</shadowSize>
                            <shadowColor>0x'.$config['sc_preview__shadowColor'].'</shadowColor>
                            <shadowAngle>'.$config['sc_preview__shadowAngle'].'</shadowAngle>
                            <preloaderColor>0x'.str_replace('#','',$config['sc_preview__preloaderColor']).'</preloaderColor>
                            <borderColor>0x'.str_replace('#','',$config['sc_preview__borderColor']).'</borderColor>
	...
	break;
        case 11:
           echo '<background>
                    <backgroundColor>0x'.str_replace("#", '', $config['sc_background__backgroundcolor']).'</backgroundColor>
                    <author>'.$config['sc_background__author'].'</author>
                    <authorSize>'.$config['sc_background__authorSize'].'</authorSize>
                    <authorColor>'.$config['sc_background__authorColor'].'</authorColor>
                    <fullAuthor>'.$config['sc_background__fullAuthor'].'</fullAuthor>
                    <borderColor>'.$config['sc_background__borderColor'].'</borderColor>
                    <borderAlpha>'.$config['sc_background__borderAlpha'].'</borderAlpha>
                    <typeback>'.$config['sc_background__typeback'].'</typeback>
                    <copytextsize>'.$config['sc_background__copytextsize'].'</copytextsize>
                    <copytextcolor>0x'.str_replace('#','',$config['sc_background__copytextcolor']).'</copytextcolor>
                    <frameWidth>'.$config['sc_background__frameWidth'].'</frameWidth>
                    <setAuthor>'.$config['sc_background__setAuthor'].'</setAuthor>
                    <backgroundAsImage>'.$config['sc_background__backgroundAsImage'].'</backgroundAsImage>
                    <showFolders>'.$config['sc_background__showFolders'].'</showFolders>
                </background>		
                <image>
                    <linkTarget>'.$config['sc_image__linkTarget'].'</linkTarget>
                    <imageAsLink>'.$config['sc_image__imageAsLink'].'</imageAsLink>
                ...
                <slideshow>
                    <time>'.$config['sc_slideshow__time'].'</time>
                    <auto>'.$config['sc_slideshow__auto'].'</auto>
                    <sendID>'.$config['sc_slideshow__sendID'].'</sendID>
                    <imgOrient>'.$config['sc_background__imgOrient'].'</imgOrient>
                    <imgAllowScale>'.$config['sc_background__imgAllowScale'].'</imgAllowScale>';
              echo '<'.get_option('1_flash_gallery_perona', MUSIC_PATH).'>'
                        .$config['sc_background__musicPath'].
                     '</'.get_option('1_flash_gallery_perona', MUSIC_PATH).'>
                </slideshow>
                <navigation>
                    <albumtextsize>'.$config['sc_navigation__albumtextsize'].'</albumtextsize>
                    <albumtextcolor>0x'.str_replace('#','',$config['sc_navigation__albumtextcolor']).'</albumtextcolor>
                    <visibleElements>'.$config['sc_navigation__visibleElements'].'</visibleElements>
                </navigation>
                <preview>
                    <scaleFactor>'.$config['sc_preview__scaleFactor'].'</scaleFactor>
                    <imageSeparator>'.$config['sc_preview__imageSeparator'].'</imageSeparator>
                    <imageWidth>'.$config['sc_preview__imageWidth'].'</imageWidth>
                    <imageHeight>'.$config['sc_preview__imageHeight'].'</imageHeight>
                    <overColor>0x'.str_replace('#','',$config['sc_preview__overColor']).'</overColor>
                    <overColorStrength>'.$config['sc_preview__overColorStrength'].'</overColorStrength>
                    <bordercolor>0x'.str_replace('#','',$config['sc_preview__bordercolor']).'</bordercolor>
                    <bordersize>'.$config['sc_preview__bordersize'].'</bordersize>
                    <borderalpha>'.$config['sc_preview__borderalpha'].'</borderalpha>
                    <showtitle>'.$config['sc_preview__showtitle'].'</showtitle>
                </preview>';
            break;
         case 12:
             echo ' <background>
                    ...
                    <image>
                        ...
                        <transitionDuration>'.$config['sc_image__transitionDuration'].'</transitionDuration>
                        <shadow>'.$config['sc_image__shadow'].'</shadow>
                        <shadowColor>0x'.str_replace('#','',$config['sc_image__shadowColor']).'</shadowColor>
                        <shadowAlpha>'.$config['sc_image__shadowAlpha'].'</shadowAlpha>
                        <shadowBlur>'.$config['sc_image__shadowBlur'].'</shadowBlur>
                        <shadowDistance>'.$config['sc_image__shadowDistance'].'</shadowDistance>
                    </image>
                   ...
                   echo '<'.get_option('1_flash_gallery_ables', MUSIC_PATH).'>'
                        .$config['sc_slideshow__mus1cPath'].
                        '</'.get_option('1_flash_gallery_ables', MUSIC_PATH).'>
                    </slideshow>
                    <navigation>
                        <hidePlayButton>'.$config['sc_navigation__hidePlayButton'].'</hidePlayButton>
                        <hideNavigateButtons>'.$config['sc_navigation__hideNavigateButtons'].'</hideNavigateButtons>
			<align>'.$config['sc_navigation__align'].'</align>
                    </navigation>	
                    <preview>
                        <width>'.$config['sc_preview__width'].'</width>
                        <enable>'.$config['sc_preview__enable'].'</enable>
                        <height>'.$config['sc_preview__height'].'</height>
                        <alpha>'.$config['sc_preview__alpha'].'</alpha>
                        <cornerRadius>'.$config['sc_preview__cornerRadius'].'</cornerRadius>
                        <transitionEffect>'.$config['sc_preview__transitionEffect'].'</transitionEffect>
                    ...
                    <scroller>
                      ...
                      <color>0x'.str_replace('#','',$config['sc_scroller__color']).'</color>
                      <alpha>'.$config['sc_scroller__alpha'].'</alpha>
	              <hidePlayButton>'.(int)$config['sc_scroller__hidePlayButton'].'</hidePlayButton>
			...
			<borderColor>0x'.str_replace('#','',$config['sc_scrollerItem__borderColor']).'</borderColor>
                        <textColor>0x'.str_replace('#','',$config['sc_scrollerItem__textColor']).'</textColor>
                        <fontSize>'.$config['sc_scrollerItem__fontSize'].'</fontSize>
			<shapeIsRect>'.$config['sc_scrollerItem__shapeIsRect'].'</shapeIsRect>
                    </scrollerItem>        
                    <customSkinItem>
                        <backgroundActiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__backgroundActiveColor']).'</backgroundActiveColor>
                        <backgroundPassiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__backgroundPassiveColor']).'</backgroundPassiveColor>
                        <backgroundActiveAlpha>'.$config['sc_customSkinItem__backgroundActiveAlpha'].'</backgroundActiveAlpha>
                        <backgroundPassiveAlpha>'.$config['sc_customSkinItem__backgroundPassiveAlpha'].'</backgroundPassiveAlpha>
                        <borderActiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__borderActiveColor']).'</borderActiveColor>
                        <borderPassiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__borderPassiveColor']).'</borderPassiveColor>
                        <borderActiveAlpha>'.$config['sc_customSkinItem__borderActiveAlpha'].'</borderActiveAlpha>
                        <borderPassiveAlpha>'.$config['sc_customSkinItem__borderPassiveAlpha'].'</borderPassiveAlpha>
                        <mainActiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__mainActiveColor']).'</mainActiveColor>
                        <mainPassiveColor>0x'.str_replace('#','',$config['sc_customSkinItem__mainPassiveColor']).'</mainPassiveColor>
                        <mainPassiveAlpha>'.$config['sc_customSkinItem__mainPassiveAlpha'].'</mainPassiveAlpha>
                        <mainActiveAlpha>'.$config['sc_customSkinItem__mainActiveAlpha'].'</mainActiveAlpha>
                        <shadowColor>0x'.str_replace('#','',$config['sc_customSkinItem__shadowColor']).'</shadowColor>
                        <shadowAlpha>'.$config['sc_customSkinItem__shadowAlpha'].'</shadowAlpha>
                        <shadowBlur>'.$config['sc_customSkinItem__shadowBlur'].'</shadowBlur>
                        <shadowDistance>'.$config['sc_customSkinItem__shadowDistance'].'</shadowDistance>
                </customSkinItem>';
	break;
	}	
	if (!in_array($album['gall_type'],array(7,8,12)))
            echo '<flickr>
