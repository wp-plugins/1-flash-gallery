...
function fgallery_install() {
   ...
   if($wpdb->get_var("SHOW TABLES LIKE '" . ALBUMS_TABLE . "'") != ALBUMS_TABLE) {
	...
	$create_images = "CREATE TABLE " . IMAGES_TABLE . " (
                              ...
                              `img_preview_path` varchar(255) collate utf8_unicode_ci default '',
                              `img_full_view_path` varchar(255) collate utf8_unicode_ci default '',
    ...
    if (version_compare($version, '1.8.0','<')) {
        $wpdb->query("ALTER TABLE ".IMAGES_TABLE." CHANGE `img_path` `img_path` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL");
    }
